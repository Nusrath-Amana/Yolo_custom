...
def bbox_sa_diou(box1, box2, lambda1=0.5, eps=1e-7):
    """
    Compute Shape-Aware Distance-IoU (SA-DIoU) between two bounding boxes.
    Box format: [x_center, y_center, width, height]
    """

    # Split boxes into coordinates and sizes
    (x1, y1, w1, h1), (x2, y2, w2, h2) = box1.chunk(4, -1), box2.chunk(4, -1)
    ...
    # Union area + epsilon for stability
    union = w1 * h1 + w2 * h2 - inter + eps
    iou = inter / union

    # Dimensions of the smallest enclosing box
    ...
    # Shape-aware term: absolute difference in aspect ratios
