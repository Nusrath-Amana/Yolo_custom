...
class Model(nn.Module):
    ...
    def _initialize_biases(self, cf=None):
        ...
        for f, s in zip(m.f, m.stride):
            ...
            # Get bias and reshape
            bias = mi.bias.data.view(m.na, -1).clone()  # Create a detached copy
            ...
            if cf is None:
                ...
                bias[:, 5:] += torch.log(cf / cf.sum())
            
            # Assign back as new parameter
            mi.bias = nn.Parameter(bias.view(-1), requires_grad=True)
